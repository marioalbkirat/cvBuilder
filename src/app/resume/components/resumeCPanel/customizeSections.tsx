            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="mb-4 p-3 rounded-lg bg-indigo-50 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className={`cursor-pointer relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${showSectionIcons ? "bg-indigo-600" : "bg-gray-300"}`}
                        ...
                        >
                            <div className="flex items-center gap-3 flex-1">
                                <button
                                    ...
                                    className={`cursor-pointer relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${section.visible ? "bg-blue-600" : "bg-gray-300"}`}
